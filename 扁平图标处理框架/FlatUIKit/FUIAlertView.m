...
- (id)initWithTitle:(NSString *)title
  ...
  otherButtonTitles:(NSString *)otherButtonTitles, ... {
    ...
    if (self) {
        ...
        backgroundOverlay.backgroundColor = [[UIColor cloudsColor] colorWithAlphaComponent:0.5f];
        [self addSubview:backgroundOverlay];
        backgroundOverlay.alpha = 0;
        _backgroundOverlay = backgroundOverlay;
        
        UIView *alertContainer = [[UIView alloc] init];
        alertContainer.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0.7f];
        alertContainer.layer.cornerRadius = 5.0f;
        ...
        titleLabel.font = [UIFont boldFlatFontOfSize:16];
        ...
        messageLabel.font = [UIFont flatFontOfSize:14];
