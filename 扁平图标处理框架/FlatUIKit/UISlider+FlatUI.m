                     ...
                     thumbColorHighlighted:(UIColor *)highlightedThumbColor
{
    ...
    UIImage *progressImage = [[UIImage imageWithColor:progressColor cornerRadius:3.0]
                              imageWithMinimumSize:CGSizeMake(6, 6)];
    UIImage *trackImage = [[UIImage imageWithColor:trackColor cornerRadius:3.0]
                           imageWithMinimumSize:CGSizeMake(6, 6)];
